...
const FieldPositions = lazy(() => import('./components/FieldPositions/fieldTable'));
const addfieldpositions = lazy(() => import('./components/FieldPositions/AddForms'));
                    ...
                    <div>
                        <Suspense fallback={<PageLoader/>}>
                            <Switch location={location}>
                                ...
                                {/*Dashboard*/}
                                <Route path="/dashboardv1"  exact={true} component={waitFor(DashboardV1)}/>
                                <Route path="/fieldpositions"  exact={true} component={waitFor(FieldPositions)}/>
                                <Route path="/fieldpositions/add-edit/:id?"  component={waitFor(addfieldpositions)}/>
